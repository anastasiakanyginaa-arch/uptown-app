        ...
        <div style={{ display: 'flex', gap: 10, alignItems: 'center' }}>
          ...
          <button onClick={() => navigator.share?.({ title: col.title, text: col.desc }).catch(() => {})} style={{ background: 'none', border: 'none', cursor: 'pointer', padding: 4 }}>
            <svg width="20" height="20" viewBox="0 0 24 24" fill="none">
              <path d="M12 3v13M8 7l4-4 4 4" stroke="#555" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round"/>
              <path d="M5 13v6a1 1 0 001 1h12a1 1 0 001-1v-6" stroke="#555" strokeWidth="1.8" strokeLinecap="round"/>
            </svg>
          </button>
